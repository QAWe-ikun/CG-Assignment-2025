...
namespace pipeline
{
	...
	static std::expected<gpu::Graphic_shader, util::Error> create_ao_shader(SDL_GPUDevice* device) noexcept
	{
		return gpu::Graphic_shader::
			create(device, shader_asset::ao_frag, gpu::Graphic_shader::Stage::Fragment, 4, 0, 0, 1)
