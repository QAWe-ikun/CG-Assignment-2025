...
namespace target
{
	...
	struct Shadow
	{
		...
		graphics::Auto_texture depth_texture_level0{depth_format};
		graphics::Auto_texture depth_texture_level1{depth_format};
		graphics::Auto_texture depth_texture_level2{depth_format};
