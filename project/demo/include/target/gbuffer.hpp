...
namespace target
{
	...
	struct Gbuffer
	{
		...
		graphics::Auto_texture depth_texture{depth_format};                  // Depth Texture
		graphics::Cycle_texture depth_value_texture{depth_value_format};     // Depth Value Texture
		graphics::Auto_texture albedo_texture{albedo_format};                // Albedo Texture
		graphics::Auto_texture lighting_info_texture{lighting_info_format};  // Lighting Info Texture
